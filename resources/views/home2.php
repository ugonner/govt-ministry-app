...
<html lang="en">
<head>
    <title>Dental Pro a Medical Category Bootstrap Responsive Website Template | Home :: w3layouts</title>
    <!-- for-mobile-apps -->
...
Smartphone Compatible web template, free web designs for Nokia, Samsung, LG, SonyEricsson, Motorola web design" />
    ...
    <!-- //for-mobile-apps -->
    <link href="/api/public/myassets/css/bootstrap.css" rel="stylesheet" type="text/css" media="all" />
    <link rel="stylesheet" href="/api/public/myassets/css/swipebox.css">
    <link href="/api/public/myassets/css/style.css" rel="stylesheet" type="text/css" media="all" />
    <!-- font-awesome icons -->
    <link href="/api/public/myassets/css/font-awesome.css" rel="stylesheet">
    <!-- //font-awesome icons -->
...
<div class="about" id="about">
                    ...
                    <div class="modal-dialog">
                        ...
                        <div class="modal-content">
                            <div class="modal-header">
                                ...
                                <img src="/api/public/myassets/images/g1.jpg" alt=" " class="img-responsive">
    ...
    <div class="spa-agile" id="services">
        <h3 class="tittle fea">What we Offer</h3>
    ...
    <div class="agile-homes-w3l  grid">
        <div class="col-md-6 home-agile-left">
            <div class="video-grid-single-page-agileits">
                <div data-video="qvRoq9ToKhw" id="video"> <img src="/api/public/myassets/images/a11.jpg" alt="" class="img-responsive" /> </div>
            </div>
        ...
        <div class="col-md-6 home-agile-left">
            <figure class="effect-moses">
                <img src="/api/public/myassets/images/a2.jpg" alt="" />
                <figcaption>
                    <h4>Dental Pro</h4>
    ...
    <div class="container">
        ...
        <div class="why-choose-agile-grids-top">
            ...
            <div class="col-md-4 agileits-w3layouts-grid img">
                <img src="/api/public/myassets/images/why.jpg" alt=" " class="img-responsive" />
            </div>
            <div class="col-md-4 agileits-w3layouts-grid">
                <div class="wthree_agile_us">
                    <div class="col-xs-3 agile-why-text">
...
<div class="team" id="team">
    <div class="container">
        ...
        <div class="w3l_team_grids">
            ...
            <div class="col-md-3 w3l_team_grid">
                <div class="view view-second">
                    <img src="/api/public/myassets/images/t4.jpg" alt=" " class="img-responsive">
                    <div class="mask"></div>
                    <div class="content">
                        <div class="w3l_social_icons w3l_social_icons1">
                            <ul>
            ...
            <div class="col-md-3 w3l_team_grid">
                <div class="view view-second">
                    <img src="/api/public/myassets/images/t1.jpg" alt=" " class="img-responsive">
                    <div class="mask"></div>
                    <div class="content">
                        <div class="w3l_social_icons w3l_social_icons1">
                            <ul>
            ...
            <div class="col-md-3 w3l_team_grid">
                <div class="view view-second">
                    <img src="/api/public/myassets/images/t2.jpg" alt=" " class="img-responsive">
                    <div class="mask"></div>
                    <div class="content">
                        <div class="w3l_social_icons w3l_social_icons1">
                            <ul>
    ...
    <div class="work-grids">
        ...
        <div class="work-grid">
            <a href="images/g2.jpg" class="b-link-stripe b-animate-go swipebox"  title="">
                <img src="/api/public/myassets/images/g2.jpg" alt="" class="img-responsive"/>
                <div class="b-wrapper">
                    <h4 class="b-animate b-from-left    b-delay03 ">
                        <p>Dental Pro</p>
                    </h4>
        ...
        <div class="work-grid">
            <a href="images/g8.jpg" class="b-link-stripe b-animate-go swipebox"  title="">
                <img src="/api/public/myassets/images/g8.jpg" alt="" class="img-responsive"/>
                <div class="b-wrapper">
                    <h4 class="b-animate b-from-left    b-delay03 ">
                        <p>Dental Pro</p>
                    </h4>
        ...
        <div class="work-grid">
            <a href="images/g3.jpg" class="b-link-stripe b-animate-go swipebox"  title="">
                <img src="/api/public/myassets/images/g3.jpg" alt="" class="img-responsive"/>
                <div class="b-wrapper">
                    <h4 class="b-animate b-from-left    b-delay03 ">
                        <p>Dental Pro</p>
                    </h4>
    ...
    <div class="work-grids two">
        <div class="work-grid">
            <a href="images/g5.jpg" class="b-link-stripe b-animate-go swipebox"  title="">
                <img src="/api/public/myassets/images/g5.jpg" alt="" class="img-responsive"/>
                <div class="b-wrapper">
                    <h4 class="b-animate b-from-left    b-delay03 ">
                        <p>Dental Pro</p>
                    </h4>
        ...
        <div class="work-grid">
            <a href="images/g4.jpg" class="b-link-stripe b-animate-go swipebox"  title="">
                <img src="/api/public/myassets/images/g4.jpg" alt="" class="img-responsive"/>
                <div class="b-wrapper">
                    <h4 class="b-animate b-from-left    b-delay03 ">
                        <p>Dental Pro</p>
                    </h4>
        ...
        <div class="work-grid">
            <a href="images/g6.jpg" class="b-link-stripe b-animate-go swipebox"  title="">
                <img src="/api/public/myassets/images/g6.jpg" alt="" class="img-responsive"/>
                <div class="b-wrapper">
                    <h4 class="b-animate b-from-left    b-delay03 ">
                        <p>Dental Pro</p>
                    </h4>
        ...
        <div class="work-grid">
            <a href="images/g7.jpg" class="b-link-stripe b-animate-go swipebox"  title="">
                <img src="/api/public/myassets/images/g7.jpg" alt="" class="img-responsive"/>
                <div class="b-wrapper">
                    <h4 class="b-animate b-from-left    b-delay03 ">
                        <p>Dental Pro</p>
                    </h4>
    ...
    <div class="container">
        ...
        <div class="agileits_w3layouts_news_grids">
            <ul id="flexiselDemo1">
                <li>
                    <div class="news-grid">
                        <img src="/api/public/myassets/images/g1.jpg" alt="">
                ...
                <li>
                    <div class="news-grid">
                        <img src="/api/public/myassets/images/g2.jpg" alt="">
                        <div class="news-grid-info">
                            <h5><span>Dental</span> Pro </h5>
                            <h4>22.10.2016</h4>
                            <p>Etiam ex lorem cursus vitae placerat suscipit dapibus tortor sed nec augue</p>
                ...
                <li>
                    <div class="news-grid">
                        <img src="/api/public/myassets/images/g3.jpg" alt="">
                        <div class="news-grid-info">
                            <h5><span>Dental</span> Pro </h5>
                            <h4>22.10.2016</h4>
                            <p>Etiam ex lorem cursus vitae placerat suscipit dapibus tortor sed nec augue</p>
                ...
                <li>
                    <div class="news-grid">
                        <img src="/api/public/myassets/images/g4.jpg" alt="">
                        <div class="news-grid-info">
                            <h5><span>Dental</span> Pro </h5>
                            <h4>22.10.2016</h4>
                            <p>Etiam ex lorem cursus vitae placerat suscipit dapibus tortor sed nec augue</p>
                ...
                <li>
                    <div class="news-grid">
                        <img src="/api/public/myassets/images/g5.jpg" alt="">
                        <div class="news-grid-info">
                            <h5><span>Dental</span> Pro </h5>
                            <h4>22.10.2016</h4>
                            <p>Etiam ex lorem cursus vitae placerat suscipit dapibus tortor sed nec augue</p>
...
<div class="contact" id="contact">
    ...
    <div class="contact-grids">
        <div class="col-md-6 agileits_w3layouts_contact">
            <div class="w3_contact_grids">
                <form action="#" method="post">
						...
						<span class="input input--jiro">
							<input class="input__field input__field--jiro" type="econtact" id="input-11" name="Econtact" placeholder="Your Email Address" required=""/>
        ...
        <div class="col-md-6 agile-w3l-map">
...
<div class="copy-right-social">
    <div class="container">
        <div class="copy-right">
            <p>&copy; 2017 Dental Pro. All rights reserved | Design by <a href="http://w3layouts.com/">W3layouts</a></p>
        </div>
...
<script src="/api/public/myassets/js/jquery-2.2.3.min.js"></script>
<!-- skills -->

<script src="/api/public/myassets/js/responsiveslides.min.js"></script>
<script>
...
<script src="/api/public/myassets/js/waypoints.min.js"></script>
<script src="/api/public/myassets/js/counterup.min.js"></script>
<script>
...
<script src="/api/public/myassets/js/simplePlayer.js"></script>
<script>
...
<script type="text/javascript" src="/api/public/myassets/js/move-top.js"></script>
<script type="text/javascript" src="/api/public/myassets/js/easing.js"></script>
...
<!--swipebox -->
<link rel="stylesheet" href="/api/public/myassets/css/swipebox.css">
<script src="/api/public/myassets/js/jquery.swipebox.min.js"></script>
<script type="text/javascript">
    jQuery(function($) {
        $(".swipebox").swipebox();
    });
...
<script type="text/javascript" src="/api/public/myassets/js/jquery.flexisel.js"></script>
<script src="/api/public/myassets/js/bootstrap.js"></script>
