    ...
    <div id="homeCarousel" class="carousel slide carousel-home" data-ride="carousel">
        ...
        <div class="carousel-inner" role="listbox">
            ...
            <div class="item active">
                ...
                <img src="{{ asset('myassets2/assets/images/slider/home-slider-1.jpg') }}" alt="">
                ...
                <div class="container">
                    ...
                    <div class="carousel-caption">
                        ...
                        <h2 class="carousel-title bounceInDown animated slow">
                            DLC provides legal advocacy for the protection of the rights of PWDs
                        </h2>
                        <h4 class="carousel-subtitle bounceInUp animated slow ">
                            DLC cares... Let's help you
                        </h4>
            ...
            <div class="item ">
                ...
                <img src="{{ asset('myassets2/assets/images/slider/home-slider-2.jpg') }}" alt="">
                ...
                <div class="container">
                    ...
                    <div class="carousel-caption">
                        ...
                        <h2 class="carousel-title bounceInDown animated slow">
                            DLC colloborates with government and agencies in policies affecting PWDs
                        </h2>
                        <h4 class="carousel-subtitle bounceInUp animated slow">
                            So let's do it !
                        </h4>
                        <a href="#" class="btn btn-lg btn-secondary hidden-xs bounceInUp animated" data-toggle="modal" data-target="#donateModal">
                            Know More
                        </a>
            ...
            <div class="item ">
                ...
                <img src="{{ asset('myassets2/assets/images/slider/home-slider-3.jpg') }}" alt="">
                ...
                <div class="container">
                    ...
                    <div class="carousel-caption">
                        ...
                        <h2 class="carousel-title bounceInDown animated slow" >
                            DLC invests in human development services for PWDs.
                        </h2>
                        <h4 class="carousel-subtitle bounceInUp animated slow">
    ...
    <div class="container">
        ...
        <div class="why-choose-agile-grids-top">
            ...
            <div class="col-md-4 agileits-w3layouts-grid img">
                <img src="{{asset('myassets/images/why.jpg') }}" alt=" " class="img-responsive" />
            </div>
            <div class="col-md-4 agileits-w3layouts-grid">
                <div class="wthree_agile_us">
                    <div class="col-xs-3 agile-why-text">
...
<div class="team" id="team">
    <div class="container">
        ...
        <div class="w3l_team_grids">
            ...
            <div class="col-md-3 w3l_team_grid">
                <div class="view view-second">
                    <img src="{{asset('myassets/images/t1.jpg') }}" alt=" " class="img-responsive">
                    <div class="mask"></div>
                    <div class="content">
                        <div class="w3l_social_icons w3l_social_icons1">
                            <ul>
            ...
            <div class="col-md-3 w3l_team_grid">
                <div class="view view-second">
                    <img src="{{asset('myassets/images/t2.jpg') }}" alt=" " class="img-responsive">
                    <div class="mask"></div>
                    <div class="content">
                        <div class="w3l_social_icons w3l_social_icons1">
                            <ul>
...
<script>window.jQuery || document.write('<script src="{{asset('myassets2/assets/js/jquery-1.11.1.min.js') }}"><\/script>')</script>

<!-- Bootsrap javascript file -->
<script src="{{asset('myassets2/assets/js/bootstrap.min.js') }}"></script>

<!-- owl carouseljavascript file -->
<script src="{{ asset('myassets2/assets/js/owl.carousel.min.js') }}"></script>

<!-- Template main javascript -->
<script src="{{ asset('myassets2/assets/js/main.js') }}"></script>
...
<script src="{{asset('myassets/js/jquery-2.2.3.min.js') }}"></script>
<!-- skills -->

<script type="text/javascript" src="{{asset('myassets/js/jquery.flexisel.js') }}"></script>
<script src="{{asset('myassets/js/bootstrap.js') }}"></script>

<script src="{{asset('myassets/js/responsiveslides.min.js') }}"></script>
<script>
...
<script src="{{asset('myassets/js/waypoints.min.js') }}"></script>
<script src="{{asset('myassets/js/counterup.min.js') }}"></script>
<script>
...
<script src="{{asset('myassets/js/simplePlayer.js') }}"></script>
<script>
...
<script type="text/javascript" src="{{asset('myassets/js/move-top.js') }}"></script>
<script type="text/javascript" src="{{asset('myassets/js/easing.js') }}"></script>
...
<script src="{{asset('myassets/js/jquery.swipebox.min.js') }}"></script>
<script type="text/javascript">
    jQuery(function($) {
        $(".swipebox").swipebox();
    });
